...
public class BehavioralFeature implements EvaluateGS {
	...
	public BehavioralFeature(int w,int l,int r,int h, int ba, int br, int re) {
		this.worker=w;
		this.light=l;
		this.ranged=r;
		this.heavy=h;
	...
	public BehavioralFeature(List<Integer> list) {
